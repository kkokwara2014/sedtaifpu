    ...
    <body data-spy="scroll" data-target="#site-nav">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p>You've inspired new consumer, racked up click-thru's, blown-up brand enes. We can't give you
                            back the weekends you worked, or erase the pain ebeing forced to make the logo bigger. But
                            if you submit your best work we ajusts might be able to give the chance to show you best
                            digital marketing.</p>

                        <figure>
                            <img alt="" class="img-responsive"
                                src="{{asset('bootstrap_assets/assets/images/about-us.jpg')}}">
                        </figure>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="speaker">
                            ...
                            <figure>
                                <img alt="" class="img-responsive center-block"
                                    src="{{asset('bootstrap_assets/assets/images/speakers/speaker-4.jpg')}}">
                            </figure>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="speaker">
                            ...
                            <figure>
                                <img alt="" class="img-responsive center-block"
                                    src="{{asset('bootstrap_assets/assets/images/speakers/speaker-5.jpg')}}">
                            </figure>
                    ...
                    <div class="col-md-4">
                        <div class="speaker">
                            <figure>
                                <img alt="" class="img-responsive center-block"
                                    src="{{asset('bootstrap_assets/assets/images/speakers/speaker-6.jpg')}}">
                            </figure>
                            <h4>Jhon Smith</h4>
                            <p>CEO of Peren</p>
                            <ul class="social-block">
                ...
                <form action="#" id="registration-form">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Phone" id="cell" name="cell"
                                    required>
                            </div>
                        </div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="site-info">Designed and <br> Developed by <a href="http://technextit.com">Technext
                                Limited</a></p>
                        <ul class="social-block">
                            <li><a href=""><i class="ion-social-twitter"></i></a></li>
                            <li><a href=""><i class="ion-social-facebook"></i></a></li>
        ...
        <script src="{{asset('bootstrap_assets/bower_components/smooth-scroll/dist/js/smooth-scroll.min.js')}}">
        </script>
